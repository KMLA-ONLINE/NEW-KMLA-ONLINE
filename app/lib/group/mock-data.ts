...
const rawGroupPosts: RawGroupPost[] = [
  {
    ...
    content:
      "# 축제 자원봉사자 모집\n\n**모집 분야**\n부스 운영과 안전 관리를 도와줄 자원봉사자를 모집합니다.\n\n활동 시간은 오전·오후 교대로 배정되며, 봉사 시간 인증서도 발급됩니다.\n\n관심 있는 분은 이번 주 금요일까지 댓글로 신청해 주세요.",
    author: { name: "김지원" },
    isPinned: true,
  ...
  },
  {
    ...
    content:
      "## 연장 운영 시간\n다음 주부터 2주간 열람실을 밤 12시까지 연장 운영합니다.\n\n\n*시험 기간에는 조용한 이용을 부탁드려요.*\n\n자리는 선착순입니다.",
    author: { name: "이현우" },
    isPinned: false,
