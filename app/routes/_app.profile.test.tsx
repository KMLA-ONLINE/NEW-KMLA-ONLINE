...
describe("ProfilePage", () => {
  ...
  it("renders the redesigned information tab content", () => {
    ...
    expect(screen.getByText("2008-03-01")).toBeInTheDocument()
  ...
  it("does not render removed activity or group content", () => {
    ...
    expect(screen.queryByText("과학기술부")).not.toBeInTheDocument()
  })
})
...
describe("ProfileEditPage", () => {
  it("renders static mock profile edit fields", () => {
    ...
    expect(screen.getByLabelText("부서")).toHaveValue("과기부")
    expect(screen.getByLabelText("생일")).toHaveValue("2008-03-01")
